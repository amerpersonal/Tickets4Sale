...
import tickets4sale.services.TicketStatusService
import tickets4sale.utils.DateUtils

import scala.concurrent.{ExecutionContext, Future}
import scala.util.{Failure, Try}

case class Show(title: String, openingDay: LocalDate, genre: Genre) extends TicketStatusService with TicketOrderEmptyRepository {
